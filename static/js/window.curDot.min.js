        ...
        var o = function(o) {
          ...
          , r = function() {
            var r = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}
              ...
              , h = b / 15;
            g.style = "position:fixed;top:0;left:0;border-radius:100%;pointer-events:none;opacity:0;z-index:".concat(d, ";height:").concat(a, "px;width:").concat(a, "px;background:").concat(x, ";border:").concat(l, "px solid ").concat(u, ";mix-blend-mode:exclusion;transition:background ").concat(h, "s,border ").concat(h, "s;will-change:transform"),
            document.addEventListener("mousemove", function(o) {
                p.x = o.clientX,
                p.y = o.clientY,
                g.style.opacity = 1,
                m || (document.body.append(g),
                f.x = p.x,
                f.y = p.y,
                m = !0,
                k())
